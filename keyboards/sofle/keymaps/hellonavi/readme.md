...
This particular [build](https://www.youtube.com/watch?v=x_57ObEjLqQ) for Sofle is forked from [lily58/druotoni](https://github.com/qmk/qmk_firmware/tree/master/keyboards/lily58/keymaps/druotoni). Layers and keymaps have been changed to ByteWelder's liking. Edit `keymap.c` to change it. Logo support is disabled in `navi_logo.c` to ensure it all fits in the available ROM space.
...
**Note: Logo customization has been removed due to memory constraints.**
...
Layers have been customized by ByteWelder. Check out `keymap.c` and adapt it to your liking.
